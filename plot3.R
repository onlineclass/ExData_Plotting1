## plot3.R script generates the third plot of the assignment - "Plot 3".
...
##      2. Create plot3.png - a png graphics file containing the time 
##         series plots of the "Sub_metering_1, 2, 3" variables
...
## 2.2 Create plot3 (the raw time series line plots of "Sub_metering_1", 
## "Sub_metering_2" and "Sub_metering_3" variables) on the png device
